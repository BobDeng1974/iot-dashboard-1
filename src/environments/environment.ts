...
export const environment = {
  ...
  //  getAssignInfoUrl : "http://34.93.22.112:8002/api/qubematics/gateway/assignInfo/",
   ...
   getDeviceHealthUrl : baseServiceUrl + "qubematics/device/getdevicehealth/?format=json",
   ...
   assignedGatewayUrl :baseServiceUrl + 'qubematics/device/createassignedgateway/',
   getAllAssignedInfo : baseServiceUrl + 'qubematics/device/getallassignedgateway/',
   //getAllNodesByBranchUrl :'http://34.93.22.112:8002/api/qubematics/gateway/getallnodes/customer/branch/',
   getAllNodesByBranchUrl :baseServiceUrl + 'qubematics/device/gatewaydetails/segment/',
   getSensorsByNodeUidUrl : baseServiceUrl + "qubematics/device/getsensor/nodeuid/",
   ...
   getVendorNameIdUrl : baseServiceUrl + "qubematics/vendor/vendornameid/?format=json",
